...
exports.assertAuthorizedByOwnersOrMembership = exports.checkCommenterAuth = exports.getOrgCollabCommentUsers = exports.checkIssueComments = exports.checkCollaborator = exports.checkAdmin = exports.getConfirm = exports.getRoleOfUser = exports.getContentsFromMaintainersFile = exports.userReturnRole = void 0;
...
exports.userReturnRole = userReturnRole;
...
var getRoleOfUser = function (arg, octokit, context) { return __awaiter(void 0, void 0, void 0, function () {
    var roleContents, rulesForRole, ifCommenterIsAdmin, ifCommenterIsMaintainer, ifCommenterIsDeveloper, admin, maintainer, developer, fordefault;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                roleContents = "", rulesForRole = "";
                return [4 /*yield*/, (0, exports.getContentsFromMaintainersFile)(octokit, context, 'maintainers.yaml')];
            case 1:
                roleContents = _a.sent();
                return [4 /*yield*/, (0, exports.getContentsFromMaintainersFile)(octokit, context, '.github/config.yaml')];
            case 2:
                rulesForRole = _a.sent();
                ...
                switch (true) {
                    case ifCommenterIsAdmin:
                        admin = (0, exports.userReturnRole)(rulesForRole, "admin");
                        return [2 /*return*/, admin];
                    case ifCommenterIsMaintainer:
                        maintainer = (0, exports.userReturnRole)(rulesForRole, "maintainer");
                        return [2 /*return*/, maintainer];
                    case ifCommenterIsDeveloper:
                        developer = (0, exports.userReturnRole)(rulesForRole, "developer");
                        return [2 /*return*/, developer];
                    default:
                        fordefault = (0, exports.userReturnRole)(rulesForRole, "default");
...
var getConfirm = function (octokit, arg, roleContent) { return __awaiter(void 0, void 0, void 0, function () {
    var toReturn, userPullRequestCount, prs, issues;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                toReturn = [];
            ...
            case 1:
                ...
                if (prs.data.length != 0) {
                    userPullRequestCount = prs.data.filter(function (pr) { return pr.user.login == arg; }).length;
                }
