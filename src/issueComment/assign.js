...
var assign = function (context) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var toReturn, token, octokit, issueNumber, commenterId, commentBody, commentArgs, _i, toReturn_1, comm, _a, iss, e_1;
        var _b;
            ...
            switch (_c.label) {
                case 0:
                                ...
                                switch (_a.label) {
                                    ...
                                    case 1:
                                        ...
                                        for (key in roleContents) {
                                            if (roleContents[key]['max-assigned-issues'] == issues) {
                                                toReturn.push(true);
                                            }
                                            else {
                                                toReturn.push(false);
                    ...
                    for (_i = 0, toReturn_1 = toReturn; _i < toReturn_1.length; _i++) {
                        comm = toReturn_1[_i];
                        if (comm == true) {
                            commentArgs = commentArgs.slice(1);
                        }
                    }
                    _a = commentArgs.length;
                    switch (_a) {
                ...
                case 3:
                    _c.trys.push([3, 5, , 6]);
                    return [4 /*yield*/, octokit.issues.addAssignees(__assign(__assign({}, context.repo), { issue_number: issueNumber, assignees: commentArgs }))];
                case 4:
                    _c.sent();
                    return [3 /*break*/, 6];
                case 5:
